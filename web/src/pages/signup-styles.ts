...
export const SignupNameStyles = css<{ valid: boolean; error: boolean }>`
  font-weight: normal;
  font-size: 16px;
  line-height: 150%;
  height: 48px;
...
export const SignupEmailStyles = css<{ valid: boolean; error: boolean }>`
  font-weight: normal;
  font-size: 16px;
  line-height: 150%;
  width: 100%;
...
export const SignupPasswordStyles = css<{ valid: boolean; error: boolean }>`
  font-weight: normal;
  font-size: 16px;
  line-height: 150%;
  color: #282828a3;
...
export const RightFooterTextTwo = styled.p`
  font-weight: normal;
  text-align: center;
  font-size: 12px;
  line-height: 15px;
...
export const LinkSignupFooter = styled.a`
  font-family: montserrat;
  font-weight: normal;
  font-size: 12px;
  line-height: 15px;
